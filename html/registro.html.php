  ...
  <body>
    ...
    <main class="row mt-5 px-5">
      <article class="col-md-6 border-end ps-5 ms-5 py-5">
        ...
        <form class="col-md-6 d-flex flex-column" action="registro.php" method="POST">
          <!-- Usuario (email) -->
          ...
          <input class="text-center border rounded mb-1 py-2 px-1" type="password" name="pass_2" placeholder="Repite la contraseña">
          <!-- Nombre -->
          <input class="text-center border rounded mb-1 py-2 px-1" type="text" name="name" placeholder="Nombre" value="<?php echo (isset($_POST['name'])) ? $_POST['name'] : '' ?>">
          <!-- Apellidos -->
          <input class="text-center border rounded mb-1 py-2 px-1" type="text" name="surname" placeholder="Apellidos" value="<?php echo (isset($_POST['surname'])) ? $_POST['surname'] : '' ?>">
          <!-- Botones del formulario -->
          <button class="btn btn-lg btn-warning text-light fw-bold px-3 py-2 mt-2" type="submit" name="button">Registrarse</button>
          <a class="link-secondary text-center small mt-2" href="index.php">o inicia sesi&oacute;n</a>
        </form>
      </article>
    </main>
